    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          ...
          createBaseVNode("div", {
            class: normalizeClass(innerClassName.value),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !shouldTeleport.value ? (openBlock(), createBlock(Transition, { key: 0 }, {
        default: withCtx(() => [
          isMounted.value ? (openBlock(), createBlock(resolveDynamicComponent(__props.tag), mergeProps({
            key: 0,
            class: className.value,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", {
        ...
        hasLinkOrTag.value ? (openBlock(), createBlock(resolveDynamicComponent(tagName.value), mergeProps({ key: 0 }, _ctx.$attrs, {
          to: __props.to,
        ...
        createVNode(Transition, { name: "fade" }, {
          default: withCtx(() => [
            isActive.value ? (openBlock(), createElementBlock("div", {
              ...
              style: normalizeStyle([widthStyle.value])
            }, [
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(Transition, null, {
          default: withCtx(() => [
            isActive.value && (_ctx.$slots.header || _ctx.$slots.body) ? (openBlock(), createElementBlock("div", {
              key: 0,
              ref_key: "popperEl",
              ref: popperEl,
...
function useMDBModal(props, emit) {
  ...
  const isModalActive = () => {
    return document.body.classList.contains("modal-open") && document.body.querySelector(".modal.show") ? true : false;
  };
  onBeforeUnmount(() => {
    if (isModalActive()) {
      resetScrollbar();
        ...
        default: withCtx(() => [
          createBaseVNode("h2", {
            ...
            createBaseVNode("button", {
              ...
              class: normalizeClass(buttonClassName.value),
              "aria-expanded": "true",
              "aria-controls": __props.collapseId,
              type: "button"
            }, [
              icon.value ? (openBlock(), createElementBlock("i", {
                key: 0,
...
var _sfc_main$p = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        class: normalizeClass(navTogglerClass.value),
        type: "button",
...
var _sfc_main$o = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(isLink.value), { class: "navbar-brand" }, {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
        _: 3
      ...
      return openBlock(), createBlock(resolveDynamicComponent(props.tag), {
        ...
        default: withCtx(() => [
          __props.to ? (openBlock(), createBlock(_component_router_link, {
            key: 0,
            class: normalizeClass(linkClassName.value),
            exact: __props.exact,
            to: __props.to,
            target: tab.value
          }, {
      ...
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          __props.prev ? (openBlock(), createElementBlock("a", {
            ...
            class: "page-link",
            href: __props.href,
            tabindex: disabledTabindex.value,
            "aria-disabled": __props.disabled,
            "aria-label": "Previous"
          }, [
            createBaseVNode("span", _hoisted_2$9, toDisplayString(prevValue.value), 1),
            _hoisted_3$6
          ...
          __props.next ? (openBlock(), createElementBlock("a", {
            ...
            createBaseVNode("span", _hoisted_5$2, toDisplayString(nextValue.value), 1),
            _hoisted_6$2
      ...
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        ...
        default: withCtx(() => [
          createBaseVNode("a", {
            ...
            __props.icon ? (openBlock(), createElementBlock("span", _hoisted_3$5, toDisplayString(labelValue.value), 1)) : renderSlot(_ctx.$slots, "default", { key: 2 })
          ], 8, _hoisted_1$8)
        ]),
        _: 3
      }, 8, ["class"]);
...
var _sfc_main$h = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        class: normalizeClass(className.value),
        "aria-current": currentName.value
      }, {
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default")
        ]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(isVertical) ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass(columnClassName.value)
      }, [
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(KeepAlive, null, [
        unref(isVertical) ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(), createBlock(resolveDynamicComponent(__props.tag), mergeProps({ class: className.value }, _ctx.$attrs), {
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "default")
            ]),
            _: 3
...
var _sfc_main$6 = defineComponent({
  ...
  setup(__props, { expose: __expose, emit }) {
    ...
    function handleInput(e) {
      const target = e.target;
      if (props.maxlength && target.value.length > props.maxlength && typeof inputValue.value === "string") {
    ...
    watchEffect(() => {
      ...
      if (typeof props.modelValue === "string") {
        if (props.maxlength && ((_a = props.modelValue) == null ? void 0 : _a.length) > props.maxlength) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        __props.label && !__props.wrap ? (openBlock(), createElementBlock("label", {
          ...
          ref_key: "labelRef",
          ref: labelRef,
          class: normalizeClass(labelClassName.value),
          for: unref(uid)
        ...
        !__props.wrap && __props.validFeedback ? (openBlock(), createElementBlock("div", {
          key: 5,
          class: normalizeClass(validFeedbackClassName.value)
        }, toDisplayString(__props.validFeedback), 3)) : createCommentVNode("", true),
        !__props.wrap && customInvalidFeedback.value ? (openBlock(), createElementBlock("div", {
          key: 6,
          class: normalizeClass(invalidFeedbackClassName.value)
        }, toDisplayString(customInvalidFeedback.value), 3)) : createCommentVNode("", true),
        ...
        __props.wrap ? withDirectives((openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
          ...
          style: normalizeStyle(validationStyle.value)
        }, {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "prepend"),
            createBaseVNode("input", mergeProps({ class: inputClassName.value }, _ctx.$attrs, {
              id: unref(uid),
              value: inputValue.value,
              onInput: handleInput,
              ref_key: "inputRef",
            ...
            customInvalidFeedback.value ? (openBlock(), createElementBlock("div", {
              key: 4,
              class: normalizeClass(invalidFeedbackClassName.value)
            }, toDisplayString(customInvalidFeedback.value), 3)) : createCommentVNode("", true),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        __props.wrap ? (openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
          ...
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "prepend"),
            createBaseVNode("textarea", mergeProps({ class: textareaClassName.value }, _ctx.$attrs, {
              id: unref(uid),
              value: textareaValue.value,
              onInput: handleInput,
              rows: __props.rows,
        ...
        (openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
          ...
          default: withCtx(() => [
            ...
            __props.thumb ? (openBlock(), createElementBlock("span", {
              key: 0,
              class: normalizeClass(thumbClassName.value),
